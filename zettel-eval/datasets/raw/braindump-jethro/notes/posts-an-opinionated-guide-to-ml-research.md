...
follow some sector of literature, and improve on existing ideas.
- **Cons:** High risk of getting snooped, or duplicating work, requires deep understanding of subject

Goal-driven

Have vision of new AI capabilities, and experiment with diferent methods across the literature. Develop your own methods to improve on them.
...
2. Aim high, and climb incrementally towards high goals
	1. Keep a notebook, and record daily ideas and experiments ([Note-taking](https://braindump.jethro.dev/posts/note_taking)). John Schulman creates an entry for each day, and conducts a review to condense entries every 1 or 2 weeks.
