...
- My theme [[minimal|Minimal]] with the [[flexoki|Flexoki]] color scheme.
...
**Most of my notes are in the root of the vault**, not a folder. This where I write about my personal world: journal entries, essays, [[evergreen-notes|evergreen]] notes, and other personal notes. If a note is in the root, I know it’s something I wrote, or relates directly to me.
...
The movie, movie theater, and restaurant each link to entries in my **References** folder. In these reference notes I capture properties, my rating, and thoughts about that thing. I use [[obsidian-web-clipper|Web Clipper]] to help populate properties from databases like IMDB. The quote was meaningful to me, so it became an [[evergreen-notes|evergreen note]] in my root folder. The essay I mention is in my **Clippings** folder, because I didn’t write it myself.
...
People have asked me if this could be automated with language models but I do not care to do so. I enjoy this process. Doing this maintenance helps me understand my own patterns. [[understand|Don’t delegate understanding]].
...
For this site, I push notes from Obsidian to a GitHub repo using the [Obsidian Git](https://obsidian.md/plugins) plugin. The notes are then automatically compiled using [Jekyll](https://jekyllrb.com/) with my web host [Netlify](https://www.netlify.com/). I also use my [[permalink-opener|Permalink Opener]] plugin to quickly open notes in the browser so I can compare the draft and live versions.
...
- [[concise|Concise explanations accelerate progress]]
- [[evergreen-notes|Evergreen notes turn ideas into objects that you can manipulate]]
- [[40-questions|40 questions to ask yourself every year]]
- [[40-questions-decade|40 questions to ask yourself every decade]]
- [[todos|How I do my to-dos]]
