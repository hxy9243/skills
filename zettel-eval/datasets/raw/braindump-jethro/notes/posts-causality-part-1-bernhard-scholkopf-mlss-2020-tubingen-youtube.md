...
[https://www.youtube.com/watch?v=btmJtThWmhA&feature=youtu.be](https://www.youtube.com/watch)
...
3. Each observable \\(X\_{i}\\) is a density, with independent unexplained random variables \\(U\_{i}, \\dots, U\_{n}\\).

The structural causal model satisfies the [[posts-causality-part-1-bernhard-scholkopf-mlss-2020-tubingen-youtube|Reichenbach’s principle]].
