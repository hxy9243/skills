...
\\begin{equation} I\_{i j}(\\boldsymbol{\\theta})=-\\mathrm{E}\_{\\mathbf{Y} | \\theta}\\left\[\\frac{\\partial^{2}}{\\partial \\theta\_{i} \\partial \\theta\_{j}} \\log p(\\boldsymbol{y} | \\boldsymbol{\\theta})\\right\] \\end{equation}
