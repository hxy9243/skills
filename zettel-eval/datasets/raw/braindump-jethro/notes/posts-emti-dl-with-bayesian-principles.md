...
[[posts-bayesian-deep-learning|Bayesian Deep Learning]], [NeurIPS](https://braindump.jethro.dev/posts/neurips)
...
\\begin{equation} \\mathrm{min}\_{\\theta} l(D, \\theta) = \\sum\_{i=1}^{N} \[y\_i - f\_{\\theta}(x\_i)^2\]
...
![](https://braindump.jethro.dev/ox-hugo/screenshot2019-12-12_16-18-19_.png)
...
![](https://braindump.jethro.dev/ox-hugo/screenshot2019-12-12_16-22-00_.png)

## Bayesian Learning Rule

- Deep learning rule: \\(\\min\_{\\theta} l(\\theta)\\)
- Bayesian learning rule: \\(\\min\_{q \\in Q} E\_{q(\\theta)} \[l (\\theta)\] - H(q)\\) where \\(H(q)\\) is entropy (regularization)
...
Gradient descent is derived from using a Gaussian with fixed covariance, and approximating \\(E\_q\[l(\\theta)\] \\approx l(m)\\).

## Resources

- [https://emtiyaz.github.io/papers/learning%5Ffrom%5Fbayes.pdf](https://emtiyaz.github.io/papers/learning%5Ffrom%5Fbayes.pdf)
