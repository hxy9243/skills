...
2. **Template Enforcement**:
   ...
   ## Recent Notes
   (Use the following exact Obsidian Dataview block to list the 50 most recently created notes. `SORT created DESC` is required so the notes are reverse chronological by created time):
