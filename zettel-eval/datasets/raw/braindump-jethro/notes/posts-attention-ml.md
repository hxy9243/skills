...
The decoder output word \\(y\_t\\) now depends on a weighted combination of all the input states, not just the last state. These attention weights \\(a\_{t,i}\\) are often normalized to sum to 1.

![](https://braindump.jethro.dev/ox-hugo/Screen-Shot-2015-12-30-at-1.16.08-PM-235x3002020-03-04_22-02-20_.png)
