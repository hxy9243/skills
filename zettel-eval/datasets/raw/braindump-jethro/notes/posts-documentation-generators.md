We use these to generate [[posts-documentation|documentation]] for projects.
...
By far my favourite now is MkDocs, and I’m using it for Org-Roam’s [documentation page](https://org-roam.readthedocs.io/en/latest). It is built using mkdocs with:
