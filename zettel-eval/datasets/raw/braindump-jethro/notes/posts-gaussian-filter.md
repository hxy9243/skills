Gaussian Filters is a tractable implementation of the Bayes filter ([[posts-bayes-filter|Bayes Filter]]) for continuous spaces.
...
Using the moments representation gives rise to the [Kalman Filter](https://braindump.jethro.dev/posts/kalman_filter).
