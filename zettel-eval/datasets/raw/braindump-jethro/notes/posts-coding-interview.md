...
Another linear-time string search algorithm is the [Rabin-Karp algorithm](https://en.wikipedia.org/wiki/Rabin%25E2%2580%2593Karp%5Falgorithm), which uses a rolling hash.
