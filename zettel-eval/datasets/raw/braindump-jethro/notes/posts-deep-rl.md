...
\\begin{equation} \\theta^{\\star}=\\arg \\max \_{\\theta} E\_{\\tau \\sim p\_{\\theta}(\\tau)}\\left\[\\sum\_{t} r\\left(\\mathbf{s}\_{t}, \\mathbf{a}\_{t}\\right)\\right\] \\end{equation}
...
- use it for planning (no explicit policy)
	- Trajectory optimization/optimal control (continuous spaces)
		- Discrete planning in discrete action spaces ([Monte Carlo Tree Search](https://braindump.jethro.dev/posts/mcts))
...
![Figure 1: Sample efficiency comparison](https://braindump.jethro.dev/ox-hugo/screenshot2019-12-16_01-35-50_.png)
...
1. [CS285 Fall 2019 - YouTube](https://www.youtube.com/playlist)
2. [Welcome to Spinning Up in Deep RL! — Spinning Up documentation](https://spinningup.openai.com/en/latest) ([Tensorflow](https://github.com/openai/spinningup), [Pytorch](https://github.com/kashif/firedup))
